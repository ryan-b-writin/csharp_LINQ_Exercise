...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.First<Cohort>(c => c.PrimaryInstructor.FirstName == "Kate");
        ...
        {
            var ActualCohort = PracticeData.First<Cohort>(c => c.JuniorInstructors.Count() > 2);
        ...
        {
            var ActualCohort = PracticeData.First(c => (c.FullTime = true) && (c.PrimaryInstructor.Birthday.Year > 2016));
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault<Cohort>(c => c.PrimaryInstructor.FirstName == "Zelda");
        ...
        {
            var shouldThrowException = PracticeData.First<Cohort>(c => (c.Active == false) && (c.FullTime == false));
        }

        [TestMethod]
        public void GetFirstCohortWith2JuniorInstructors()
        {
            var ActualCohort = PracticeData.First<Cohort>(c => c.JuniorInstructors.Count() > 1);
